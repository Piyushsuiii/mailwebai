...
A complete walkthrough of the application, covering UI, authentication, AI features, and payments.

### ⏱️ Timeline

- **0:00** — Landing Page UI  
- **0:32** — User Login Flow  
- **0:48** — Email Link & Verification  
- **1:32** — AI Assistant Chatbot  
- **7:14** — Payments Integration  
